...
TEST_F(NGraphReaderTests, MaxPool2DNonDefault) {
  std::string model = R"V0G0N(
<net name="model" version="10">
	<layers>
		<layer id="0" name="x" type="Parameter" version="opset1">
			<data element_type="f32" shape="1,1,5,5"/>
			<output>
				<port id="0" precision="FP32">
					<dim>1</dim>
					<dim>1</dim>
		...
		<layer id="1" name="y" type="MaxPool" version="opset1">
			<data kernel="5,5" pads_begin="2,2" pads_end="2,2" rounding_type="floor" strides="1,1"/>
			<input>
				<port id="0">
					<dim>1</dim>
					<dim>1</dim>
...
<net name="model" version="7">
	<layers>
		...
		<layer id="1" name="y" type="Pooling" version="opset1">
			<data exclude-pad="true" kernel="5,5" pads_begin="2,2" pads_end="2,2" pool-method="max" rounding_type="floor" strides="1,1"/>
			<input>
				<port id="0">
					<dim>1</dim>
					<dim>1</dim>
